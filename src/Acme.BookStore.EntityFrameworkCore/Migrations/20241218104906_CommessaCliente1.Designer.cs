...
namespace Acme.BookStore.Migrations
{
    ...
    [Migration("20241218104906_CommessaCliente1")]
    partial class CommessaCliente1
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Acme.BookStore.Clienti.Cliente", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");

                    b.PrimitiveCollection<string>("CommesseId")
                        .IsRequired()
            ...
            modelBuilder.Entity("Acme.BookStore.Commesse.Commessa", b =>
                {
                    ...
                    b.PrimitiveCollection<string>("Dipendenti")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Acme.BookStore.Dipendenti.Dipendente", b =>
                {
                    ...
                    b.ToTable("AppDipendenti", (string)null);
                });

            modelBuilder.Entity("Acme.BookStore.Dipendenti.DipendenteCommessa", b =>
                {
                    ...
                    b.Property<int>("MonteOre")
                        .HasColumnType("int");

                    b.Property<int>("Ruolo")
                        .HasColumnType("int");

                    b.HasKey("DipendenteId", "CommessaId");

                    b.HasIndex("CommessaId");

                    b.HasIndex("DipendenteId");

                    b.ToTable("AppDipendentiCommesse", (string)null);
                });
            ...
            modelBuilder.Entity("Acme.BookStore.Dipendenti.DipendenteCommessa", b =>
                {
                    b.HasOne("Acme.BookStore.Commesse.Commessa", null)
                        .WithMany()
                        .HasForeignKey("CommessaId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Acme.BookStore.Dipendenti.Dipendente", null)
                        .WithMany()
