...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p c035b227-48ad-430e-9758-c58fcf1da372
```

> `c035b227-48ad-430e-9758-c58fcf1da372` is the password of the certificate, you can change it to any password you want.
